...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"flair/card","version":"0.2.0","title":"Card","category":"flair","description":"It\'s like a link with tons of context.","supports":{"align":["left","right","center","wide"],"anchor":true,"color":{"background":true,"text":true},"html":false,"layout":{"allowSwitching":true},"shadow":true,"spacing":{"margin":true,"padding":true,"blockGap":false},"typography":{"fontSize":true,"lineHeight":true,"textAlign":true}},"attributes":{"href":{"type":"string","default":"#"},"target":{"type":"string"},"asset":{"type":"object","default":{"url":null},"id":{"type":"number"},"url":{"type":"string"},"alt":{"type":"string"}},"title":{"type":"string"},"meta":{"type":"string","source":"html","selector":".meta"},"excerpt":{"type":"string"},"attribution":{"type":"string"},"button":{"type":"string"},"orientation":{"type":"string","default":"auto"},"aspect":{"type":"string","default":"none"},"heading":{"type":"string","default":"h3"},"call":{"type":"string","source":"text","selector":".call"}},"example":{"attributes":{"asset":{"url":"https://pd.w.org/2023/03/8636413c9dfe23357.98014051-768x512.jpg"},"title":"Faciamo così","excerpt":"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent et eros eu felis.","button":"Explore","orientation":"vertical","aspect":"16-9"}},"textdomain":"flair","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php"}');
